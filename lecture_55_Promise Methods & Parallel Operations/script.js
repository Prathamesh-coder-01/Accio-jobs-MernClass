...
race → First finished
any → First success
allSettled → All results (success + failure)
-----------------------------------------------------------
 

1️. What is a Promise in JavaScript?

 ---> A Promise is an object that represents the future result of an asynchronous
 operation (like fetching data, reading files, timers).
